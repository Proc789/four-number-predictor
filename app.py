# app-hotboost-v5-rhythm (觀察納入節奏統計 + 命中統計 + 保底補碼 + 公版UI)
...
<body style='max-width: 400px; margin: auto; padding: 20px; font-family: sans-serif;'>
  ...
  <form method='POST'>
    <input name='first' id='first' placeholder='冠軍' required style='width: 100%; padding: 8px;' oninput="moveToNext(this, 'second')" inputmode='numeric'><br><br>
    <input name='second' id='second' placeholder='亞軍' required style='width: 100%; padding: 8px;' oninput="moveToNext(this, 'third')" inputmode='numeric'><br><br>
...
@app.route('/observe')
def observe():
    global was_observed, observation_message, current_stage, actual_bet_stage
    was_observed = True
